...
namespace mfmFFSDB
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="NYAWeighmentSRS")]
    ...
    partial void InsertTrnsDispatchMultiDetail(TrnsDispatchMultiDetail instance);
    partial void UpdateTrnsDispatchMultiDetail(TrnsDispatchMultiDetail instance);
    partial void DeleteTrnsDispatchMultiDetail(TrnsDispatchMultiDetail instance);
    partial void InsertTrnsDispatchMultiHeader(TrnsDispatchMultiHeader instance);
    partial void UpdateTrnsDispatchMultiHeader(TrnsDispatchMultiHeader instance);
    partial void DeleteTrnsDispatchMultiHeader(TrnsDispatchMultiHeader instance);
    ...
    partial void DeleteTrnsRawMaterialReturn(TrnsRawMaterialReturn instance);
		...
		public System.Data.Linq.Table<TrnsDispatchMultiDetail> TrnsDispatchMultiDetail
		{
			get
			{
				return this.GetTable<TrnsDispatchMultiDetail>();
			}
		}
		
		public System.Data.Linq.Table<TrnsDispatchMultiHeader> TrnsDispatchMultiHeader
		{
			get
			{
				return this.GetTable<TrnsDispatchMultiHeader>();
			}
		}
		...
		[Function(Name="dbo.GetSumOpenValueSOIteration")]
		public ISingleResult<GetSumOpenValueSOIterationResult> GetSumOpenValueSOIteration([Parameter(Name="SBRNum", DbType="NVarChar(50)")] string sBRNum, [Parameter(Name="CardCode", DbType="NVarChar(50)")] string cardCode, [Parameter(Name="ItemCode", DbType="NVarChar(50)")] string itemCode, [Parameter(Name="DocNum", DbType="Int")] System.Nullable<int> docNum, [Parameter(Name="ReturnValue", DbType="Decimal(18,3)")] ref System.Nullable<decimal> returnValue)
		{
			...
			return ((ISingleResult<GetSumOpenValueSOIterationResult>)(result.ReturnValue));
		}
		
		[Function(Name="dbo.GetSumOpenValueSOMulti")]
		public ISingleResult<GetSumOpenValueSOMultiResult> GetSumOpenValueSOMulti([Parameter(Name="SBRNum", DbType="NVarChar(50)")] string sBRNum, [Parameter(Name="CardCode", DbType="NVarChar(50)")] string cardCode, [Parameter(Name="ItemCode", DbType="NVarChar(50)")] string itemCode, [Parameter(Name="ReturnValue", DbType="Decimal(18,3)")] ref System.Nullable<decimal> returnValue)
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), sBRNum, cardCode, itemCode, returnValue);
			returnValue = ((System.Nullable<decimal>)(result.GetParameterValue(3)));
			return ((ISingleResult<GetSumOpenValueSOMultiResult>)(result.ReturnValue));
		}
	...
	public partial class MstUsers : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<bool> _FlgTolerance;
    ...
    partial void OnUpdatedByChanging(string value);
    partial void OnUpdatedByChanged();
    partial void OnFlgToleranceChanging(System.Nullable<bool> value);
    partial void OnFlgToleranceChanged();
		...
		[Column(Name="flgTolerance", Storage="_FlgTolerance", DbType="Bit")]
		public System.Nullable<bool> FlgTolerance
		{
			get
			{
				return this._FlgTolerance;
			}
			set
			{
				if ((this._FlgTolerance != value))
				{
					this.OnFlgToleranceChanging(value);
					this.SendPropertyChanging();
					this._FlgTolerance = value;
					this.SendPropertyChanged("FlgTolerance");
					this.OnFlgToleranceChanged();
				}
			}
		}
    ...
    partial void OnToleranceLimitChanged();
		...
		[Column(Storage="_ToleranceLimit", DbType="Decimal(18,6)")]
		public System.Nullable<decimal> ToleranceLimit
		{
			get
			{
				return this._ToleranceLimit;
			}
			set
			{
				if ((this._ToleranceLimit != value))
				{
					this.OnToleranceLimitChanging(value);
					this.SendPropertyChanging();
	...
	[Table(Name="dbo.TrnsDispatchMultiDetail")]
	public partial class TrnsDispatchMultiDetail : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnFlgPostedChanged();
		...
		public TrnsDispatchMultiDetail()
		{
			OnCreated();
		}
	...
	[Table(Name="dbo.TrnsDispatchMultiHeader")]
	public partial class TrnsDispatchMultiHeader : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _ToleranceLimitABy;
    ...
    partial void OnToleranceLimitChanging(System.Nullable<decimal> value);
    partial void OnToleranceLimitChanged();
    partial void OnToleranceLimitAByChanging(string value);
    partial void OnToleranceLimitAByChanged();
    #endregion
		
		public TrnsDispatchMultiHeader()
		{
			OnCreated();
		}
		...
		[Column(Storage="_TransportCode", DbType="NVarChar(100)")]
		public string TransportCode
		{
			get
			{
		...
		[Column(Storage="_TransportName", DbType="NVarChar(100)")]
		public string TransportName
		{
			get
			{
		...
		[Column(Storage="_ToleranceLimitABy", DbType="NVarChar(50)")]
		public string ToleranceLimitABy
		{
			get
			{
				return this._ToleranceLimitABy;
			}
			set
			{
				if ((this._ToleranceLimitABy != value))
				{
					this.OnToleranceLimitAByChanging(value);
					this.SendPropertyChanging();
					this._ToleranceLimitABy = value;
					this.SendPropertyChanged("ToleranceLimitABy");
					this.OnToleranceLimitAByChanged();
				}
			}
		}
	...
	public partial class TrnsRawMaterial : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<bool> _FlgAPRI;
    ...
    partial void OnFlgAPRIChanging(System.Nullable<bool> value);
    partial void OnFlgAPRIChanged();
    partial void OnFlgToleranceChanging(System.Nullable<bool> value);
    partial void OnFlgToleranceChanged();
    partial void OnToleranceLimitChanging(System.Nullable<decimal> value);
    partial void OnToleranceLimitChanged();
		...
		[Column(Name="flgAPRI", Storage="_FlgAPRI", DbType="Bit")]
		public System.Nullable<bool> FlgAPRI
		{
			get
			{
				return this._FlgAPRI;
			}
			set
			{
				if ((this._FlgAPRI != value))
				{
					this.OnFlgAPRIChanging(value);
					this.SendPropertyChanging();
					this._FlgAPRI = value;
					this.SendPropertyChanged("FlgAPRI");
					this.OnFlgAPRIChanged();
				}
			}
		}
	...
	public partial class GetSumOpenValueSOIterationResult
	{
		
		private System.Nullable<decimal> _ReturnValue;
		
		public GetSumOpenValueSOIterationResult()
		{
		}
	...
	public partial class GetSumOpenValueSOMultiResult
	{
		
		private System.Nullable<decimal> _ReturnValue;
		
		public GetSumOpenValueSOMultiResult()
		{
		}
